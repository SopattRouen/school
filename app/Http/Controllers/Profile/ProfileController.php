...
class ProfileController extends MainController
{
    ...
    public function view(){
        ...
        $user=UserModel::select('id','name','phone','email','avatar')->where('id',$auth->id)->first();
    ...
    public function changePassword(Request $req)
    {
        ...
        if (Hash::check($val['old_password'], $user->password)) {
            // Update password field
            $user->password = Hash::make($val['new_password']);
